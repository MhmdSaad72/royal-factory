...
@section('title', __('translations.next_expirations'))

@section('content_header')
    <h1>{{ __('translations.next_expirations') }}</h1>
@stop
          ...
          <div class="col-md-9">
              <div class="card">
                  <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('orders.next.expire') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
