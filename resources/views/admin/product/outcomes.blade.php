...
@section('title', __('translations.product_outcomes'))

@section('content_header')
    <h1 class="header">{{ __('translations.product_outcomes') }}</h1>
@stop
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        @if ($product->hasOutcomes() > 0)
                      </form>
                      <form method="GET" action="{{ route('products.outcomes' , ['id'=>$product->id]) }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
